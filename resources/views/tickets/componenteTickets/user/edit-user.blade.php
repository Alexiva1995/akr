                        ...
                        <form action="{{route('ticket.update-user', $ticket->id)}}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mt-2 mb-2">
                                    ...
                                    <span class="text-danger text-bold-600">Descripción</span>
                                    <textarea class="form-control border  rounded-0" type="text" id="message" name="message" required rows="3"></textarea>
                                </div>

                            </div>

                            <div class="col-12">
                                <button type="submit" class="btn btn-primary mr-1 mb-1 waves-effect waves- float-right">Actualizar
                                    Ticket</button>
                            </div>
                        </form>
                    </div>
