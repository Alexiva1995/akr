...
@endpush
@section('content')
    <h1 class="text-white mb-1 ml-2">Arbol Binario</h1>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-12 art" id="tarjeta">
                <div class="container">
                    <div class="row">
                        <div class="col-4">
                            <img id="imagen" class="p-1" style="width: 118%;margin-top: 7px;padding-top: 15px;"
                                height="80px">
                        </div>
                ...
                <li class="baseli">
                    <a class="base" href="#">
                        @if (empty($base->photoDB))
                            <img src="{{ asset('assets/img/sistema/favicon.png') }}" alt="{{ $base->name }}"
